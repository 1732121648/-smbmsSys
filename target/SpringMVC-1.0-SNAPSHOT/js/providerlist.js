...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/jsp/queryByIdProvider?method=view&id="+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/queryByIDUpdateProvider?method=modify&id="+ obj.attr("proid");
	});
