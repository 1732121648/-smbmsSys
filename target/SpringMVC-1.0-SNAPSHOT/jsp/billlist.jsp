...
<div class="right">
       ...
       <div class="search">
       <form method="get" action="${pageContext.request.contextPath }/jsp/allPageBill.action">
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billPage.datas }" varStatus="status">
				<tr>
					<td>
	...
	<input type="hidden" id="totalPageCount" value="${billPage.totalPage}"/>
	<c:import url="rollpage.jsp" charEncoding="UTF-8">
		<c:param name="totalCount" value="${billPage.totalRow}"/>
		<c:param name="currentPageNo" value="${billPage.pageNo}"/>
		<c:param name="totalPageCount" value="${billPage.totalPage}"/>
	</c:import>
  </div>
</section>
