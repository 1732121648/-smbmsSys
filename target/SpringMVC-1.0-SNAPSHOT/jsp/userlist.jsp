...
<%@include file="/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="get"action="${pageContext.request.contextPath }/jsp/user/queryAllPage">
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${userList.datas }" varStatus="status">
					<tr>
						<td>
			...
			<input type="hidden" id="totalPageCount" value="${userList.totalPage}"/>
		  	<c:import url="rollpage.jsp" charEncoding="UTF-8">
	          	<c:param name="totalCount" value="${userList.totalRow}"/>
	          	<c:param name="currentPageNo" value="${userList.pageNo}"/>
