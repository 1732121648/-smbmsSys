...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/jsp/allByProvider.do">
				<input name="method" value="query" type="hidden">
				<span>供应商编码：</span>
				<input name="procode" type="text" value="${queryProCode }">
				
				<span>供应商名称：</span>
				<input name="proname" type="text" value="${queryProName }">
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${providerList.datas }" varStatus="status">
				<tr>
					<td>
	...
	<c:import url="rollpage.jsp" charEncoding="UTF-8">
		<c:param name="totalCount" value="${providerList.totalRow}"/>
		<c:param name="currentPageNo" value="${providerList.pageNo}"/>
